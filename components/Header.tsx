			...
			<motion.div
				...
				<motion.div
					...
					<div className="flex gap-2 items-center">
						<a href="/contact" className="text-white text-[16px] leading-tight font-normal">
							Get in touch
						</a>
						<Image
							src={arrowRightWhite}
							...
							item.title === "Products" ? (
								<div
									...
									<div className="flex items-center gap-1">
										<span className="text-[18px] font-normal leading-tight text-[#00000099] cursor-pointer">
											{item.title}
										</span>
										<motion.div
