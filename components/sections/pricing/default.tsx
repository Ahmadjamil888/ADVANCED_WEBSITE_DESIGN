...
export default function Pricing({
  ...
  plans = [
    ...
    },
    {
      ...
      features: [
        `${siteConfig.stats.projects}+ AI projects delivered`,
        `${siteConfig.stats.clients}+ satisfied clients`,
        `${siteConfig.stats.aiModels}+ ML models deployed`,
        `${siteConfig.stats.technologies}+ technologies mastered`,
        `${siteConfig.stats.experience} of experience`,
      ],
      variant: "glow-brand",
    },
    {
