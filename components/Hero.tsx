...
export default function Hero() {
	...
	const phares1 = ["From concepts to ", "reality"];
	const phares2 = [
		"Transform your ideas into powerful solutions with cutting-edge AI, ML, Data Science, and Software Development expertise. Zehanx Technologies brings innovation to life.",
	];
	return (
		<div
			ref={container}
