...
const navigationMenuTriggerStyle = cva(
  "nav-item-professional group inline-flex h-10 w-max items-center justify-center rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-300 hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 data-active:bg-primary/15 data-[state=open]:bg-primary/15",
);
