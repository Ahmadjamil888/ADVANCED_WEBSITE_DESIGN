...
export async function POST(request: NextRequest) {
  try {
    ...
    // Generate predicted Space URL for immediate feedback
    ...
    const predictedSpaceUrl = `https://huggingface.co/spaces/dhamia/${spaceName}`;
    ...
    return NextResponse.json({
      ...
      apiUrl: `https://api-inference.huggingface.co/models/dhamia/${spaceName}`,
      spaceName,
      modelType,
