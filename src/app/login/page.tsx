            ...
            <div className="w-full flex-1 mt-8">
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <span className="ml-4">{isSignUp ? 'Sign Up' : 'Sign In'} with Google</span>
                </button>
                ...
                >
                  ...
                  <span className="ml-4">{isSignUp ? 'Sign Up' : 'Sign In'} with GitHub</span>
                </button>
              </div>
              ...
              <form onSubmit={handleEmailAuth} className="mx-auto max-w-xs">
                <input
