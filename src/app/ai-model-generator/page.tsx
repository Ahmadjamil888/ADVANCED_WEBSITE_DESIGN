              ...
              <div style={{ padding: '2rem' }}>
                {showAWSOption && !deploymentResult ? (
                  ...
                  <div>
                    <div className="prompt-section">
                      ...
                      <div style={{ marginBottom: '2rem' }}>
                        <label style={{ display: 'block', color: '#ffffff', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: '600' }}>Model Name (Optional)</label>
                        <input 
                          type="text"
                  ...
                  <div className="deployment-result-card">
                    ...
                    <h2 style={{ marginTop: '2rem' }}>✓ Model Deployed Successfully!</h2>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginTop: '2rem' }}>
                      <button 
                        ...
                        onClick={() => {
                          ...
                          const modelData = JSON.stringify(deploymentResult, null, 2);
                          const blob = new Blob([modelData], { type: 'application/json' });
                          const url = URL.createObjectURL(blob);
                          const a = document.createElement('a');
                          a.href = url;
                          a.download = `model-${deploymentResult.sandboxId}.json`;
                          a.click();
                          URL.revokeObjectURL(url);
                        }}
                      >
                        <svg stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2"></path>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M7 11l5 5l5 -5"></path>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 4l0 12"></path>
                        </svg>
