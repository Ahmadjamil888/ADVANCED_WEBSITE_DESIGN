...
export default function LogoMarquee() {
  ...
  return (
    <div className="relative w-full overflow-hidden py-6 sm:py-8">
      {/* Blurry gradient overlays for fade effect on both ends */}
      <div className="absolute left-0 top-0 bottom-0 w-20 sm:w-40 bg-gradient-to-r from-black via-black/80 to-transparent z-10 pointer-events-none backdrop-blur-[2px]" />
      <div className="absolute right-0 top-0 bottom-0 w-20 sm:w-40 bg-gradient-to-l from-black via-black/80 to-transparent z-10 pointer-events-none backdrop-blur-[2px]" />
