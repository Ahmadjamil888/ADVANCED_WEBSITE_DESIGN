    ...
    <section id="insights" className="relative w-full bg-black py-20 sm:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="relative p-5 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/10"
            >
              {/* Rating */}
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 text-sm font-medium">
        ...
        >
          <a
            href="#get-started"
            className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-white font-medium bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300"
          >
