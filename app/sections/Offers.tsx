...
const offerTiers = [
  {
    ...
    subtitle: "Anchor Offer — $15k to $50k+",
    description: "Full-scale AI infrastructure including custom LLMs, multi-agent systems, and autonomous platforms.",
    features: [
      "Custom Fine-tuned LLMs (GPT, Llama, Claude)",
      "Multi-Agent Orchestration Layers",
      "Enterprise RAG & Vector Databases",
      "Full System Integration & Security",
      "Custom AI Dashboards & Monitoring",
    ],
    cta: "Outcome: Full Autonomous Operations",
  },
  {
    icon: Zap,
    number: "2",
    title: "AI Automation Starter",
    subtitle: "Wedge Offer — $499 to $999",
    description: "We automate ONE friction-point in your business in 7 days. Proof-of-utility sprint.",
    features: [
      "1 Custom AI Agent (Lead Gen / Sales / Ops)",
      "Workflow Automation (Zapier / Make / Python)",
      "LLM Integration POC",
      "Strategy & Implementation Roadmap",
      "Normally $2,500+ — First 5 Clients only",
    ],
    cta: "Outcome: Instant Efficiency & Proof",
  },
  {
    icon: BarChart3,
    number: "3",
    title: "AI Intelligence Layer",
    subtitle: "Growth Tier — $3k to $10k",
    description: "Deep integration of AI into your existing product or internal business workflows.",
    features: [
      "Process-specific AI Copilots",
      "Data Cleaning & Analysis Engines",
      "Custom Prompt Engineering Suites",
      "API Development & AI Scaling",
      "Ongoing Performance Tuning",
    ],
    cta: "Outcome: Measurable Human-Lite Scaling",
  },
];
