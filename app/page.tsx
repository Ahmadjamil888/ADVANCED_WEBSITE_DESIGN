      ...
      <section className="py-20 bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="max-w-container mx-auto px-4 relative z-10">
          <div className="text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-white animate-fade-in-up">
              Experience the Future of AI with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Zehan GPT</span>
            </h2>
            <p className="text-gray-300 text-lg max-w-3xl mx-auto mb-12 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              Pakistan's most advanced AI assistant, powered by cutting-edge technology. Get intelligent answers, creative solutions, and expert guidance.
            </p>
            
            <div className="animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              <Link 
                href="/zehan" 
                className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-12 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group"
              >
                <svg className="w-6 h-6 mr-3 group-hover:animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
                Try Our First AI - Zehan GPT
