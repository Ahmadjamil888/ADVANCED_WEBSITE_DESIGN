...
export default function Contact() {
	...
	const socialLinks = [
		{ id: 1, name: "LinkedIn", description: "Connect with our AI researchers", link: "https://linkedin.com" },
		{ id: 2, name: "GitHub", description: "Explore our AI models and research", link: "https://github.com" },
		{ id: 3, name: "Twitter", description: "Follow our AI research updates", link: "https://twitter.com" },
		{ id: 4, name: "Research Papers", description: "Read our publications", link: "https://arxiv.org" },
	];
	...
	const faqs = [
		{
			...
			answer:
				"Project timelines vary based on scope and complexity. We typically provide detailed timelines after the discovery phase. Most projects range from 2-6 months.",
		},
		{
			id: 2,
			question: "Do you offer ongoing support?",
			answer:
				"Yes, we provide comprehensive maintenance and support packages. We can discuss your specific needs during our consultation.",
		},
		{
			id: 3,
			question: "What technologies do you specialize in?",
			answer:
				"We specialize in innovative software solutions, AI/ML technologies, cybersecurity, and enterprise-grade software products. We work with modern technologies like React, Python, TensorFlow, PyTorch, and cloud platforms.",
		},
		{
			id: 4,
			question: "How do you ensure project quality?",
			answer:
				"We follow rigorous quality assurance processes including code reviews, automated testing, and comprehensive testing before deployment.",
		},
		{
			id: 5,
			question: "Can you work with existing systems?",
			answer:
				"Absolutely! We can integrate with your existing systems and provide seamless solutions that work with your current infrastructure.",
		},
		{
			id: 6,
			question: "What is your pricing model?",
			answer:
				"We offer flexible pricing models including fixed-price projects, time &amp; materials, and retainer-based engagements. Contact us for a custom quote.",
		},
	];
			...
			<div className="pt-20">
					...
					<div className="w-full flex flex-col gap-10 items-center justify-center">
						<div className="overflow-hidden">
							<motion.div variants={textAnimation} initial="initial" whileInView="enter" viewport={{ once: true }}>
								<Heading classname="heading font-bold text-center" title={phares1} />
							</motion.div>
						</div>
						<div className="overflow-hidden max-w-2xl">
							<motion.div variants={textAnimation} initial="initial" whileInView="enter" viewport={{ once: true }}>
								<Heading classname="paragraph font-normal text-center" title={phares2} />
							</motion.div>
						</div>
					</div>
				</div>
					...
					<div className="w-full flex flex-col gap-10">
						<div className="w-full flex items-center flex-col gap-3">
							<motion.div
								...
								viewport={{ once: true }}>
								<button className="w-fit py-2 px-3 rounded-full border border-[#2222221A] text-black font-dmSans text-sm font-medium">
									Contact Details
								</button>
							</motion.div>
						</div>
						...
						<div className="w-full grid grid-cols-3 gap-8 xm:grid-cols-1 sm:grid-cols-1">
							{contactMethods.map((method) => (
								<motion.div
									...
									<a href={method.link}>
										<Button className="text-white bg-black py-2 px-4 w-full" title={method.linkText} />
									</a>
								</motion.div>
							))}
						</div>
				...
				<div className="w-full padding-x py-20 bg-gradient-to-b from-white to-[#d2dcff] xm:py-10 sm:py-10">
					<div className="w-full flex flex-col gap-8 items-center justify-center text-center">
						<motion.div variants={textAnimation} initial="initial" whileInView="enter" viewport={{ once: true }}>
							<h2 className="heading font-bold">Ready to innovate with our software solutions?</h2>
						...
						<motion.div
							...
							<a href={`mailto:${contactInfo.email}`} className="w-full xm:w-full sm:w-full">
								<Button className="text-white bg-black py-2 px-4 w-full" title={`Email: ${contactInfo.email}`} />
							</a>

							<a href={`tel:${contactInfo.phone}`} className="w-full xm:w-full sm:w-full">
								<Button className="text-black bg-white py-2 px-4 w-full border border-black" title={`Call: ${contactInfo.phone}`} />
							</a>
						</motion.div>
					</div>
				</div>
